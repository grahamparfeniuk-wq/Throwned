export const styles = {
  ...
  peekCard: {
    ...
    background: "linear-gradient(168deg, rgba(14,16,22,.97) 0%, rgba(6,8,12,.94) 52%, rgba(5,6,10,.96) 100%)",
    backdropFilter: "blur(22px)",
    WebkitBackdropFilter: "blur(22px)",
    padding: "18px 40px 16px 16px",
    boxShadow: "0 24px 64px rgba(0,0,0,.50), inset 0 1px 0 rgba(255,255,255,.05)",
  },
  peekClose: {
    position: "absolute",
    top: 8,
